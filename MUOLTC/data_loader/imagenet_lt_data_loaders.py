...
class ImageNetLTDataLoader(DataLoader):
    def __init__(self,data_dir,batch_size,num_workers,training=True,retain_epoch_size=True):
        ...
        if training:
            self.dataset = LT_Dataset('/home/lzh/ImageNet_LT','/home/lzh/ImageNet_LT/ImageNet_LT_train.txt',train_trsfm)
            self.val_dataset = LT_Dataset('/home/lzh/ImageNet_LT','/home/lzh/ImageNet_LT/ImageNet_LT_val.txt',test_trsfm)
        else: # test
